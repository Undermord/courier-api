...
echo "API доступен по адресу http://localhost:8080/api/"
echo "Swagger документация доступна по адресу http://localhost:8080/api/swagger-ui.html"
